...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="index.php">
            <img src="<?php echo base_url();?>assets/img/launch.png" width="30" height="30" class="d-inline-block align-top" alt="">
            RIAN RAKA BLOG
        </a>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('<?php echo base_url();?>assets/img/Hometown.png')">
      <div class="overlay"></div>
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="post-heading">
              <h1>this is my photo collection</h1>
              <h2 class="subheading">Never forget where you come from</h2>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <a href="#">
              <img class="img-fluid" src="<?php echo base_url();?>assets/img/pic1.jpg" alt="">
            </a>
            <a href="#">
              <img class="img-fluid" src="<?php echo base_url();?>assets/img/pic2.jpg" alt="">
            </a>
            <a href="#">
              <img class="img-fluid" src="<?php echo base_url();?>assets/img/pic3.jpg" alt="">
            </a>
